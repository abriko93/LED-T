...
uint8_t LED_count = 0;
uint8_t GREEN[LEDSNUMBER] = {0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,
...
uint8_t RED[LEDSNUMBER]  =  {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
uint8_t BLUE[LEDSNUMBER]  = {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                             0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                             0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                             0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                             0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
//¬се управление светодиодом происходит в прерывани€х
  ...
  /*
  while(!DMA_GetFlagStatus(SPI_LED_Tx_DMA_FLAG));
...
void DMA_LED_Config(void)
{
  ...
  DMA_InitStructure.DMA_BufferSize = BUFFERSIZE+1;                               /*!< Specifies the buffer size, in data unit, of the specified Channel.*/
